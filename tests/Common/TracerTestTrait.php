        ...
        foreach ($rawTraces as $spansInTrace) {
            ...
            foreach ($spansInTrace as $rawSpan) {
                $spanContext = new SpanContext(
                    sfx_trace_convert_hex_id($rawSpan['trace_id']),
                    sfx_trace_convert_hex_id($rawSpan['span_id']),
                    isset($rawSpan['parent_id']) ? sfx_trace_convert_hex_id($rawSpan['parent_id']) : null
                );
