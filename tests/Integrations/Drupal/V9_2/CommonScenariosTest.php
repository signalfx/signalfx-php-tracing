...
final class CommonScenariosTest extends WebFrameworkTestCase
{
    ...
    public static function ddSetUpBeforeClass()
    {
        ...
        $result = $pdo->exec(file_get_contents(__DIR__ . '/../../../Frameworks/Drupal/drupal-9.2.10/db.sql'));
        if ($result === false) {
            WebFrameworkTestCase::assertSame('No error from DB setup', $pdo->errorInfo());
        }
    }
