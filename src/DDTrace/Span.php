    ...
    class Span extends DataSpan
    {
        ...
        public function setTag($key, $value, $setIfFinished = false)
        {
            ...
            if (array_key_exists($key, self::$specialTags)) {
                ...
                if ($key === Tag::HTTP_STATUS_CODE && $value >= 500) {
                    $this->hasError = true;
                    if (!isset($this->internalSpan->meta[Tag::ERROR_KIND])) {
                        $this->internalSpan->meta[Tag::ERROR_KIND] = 'Internal Server Error';
                    }
                }
        ...
        public function setError($error)
        {
            if (($error instanceof Exception) || ($error instanceof Throwable)) {
                ...
                $this->internalSpan->meta[Tag::ERROR_KIND] = get_class($error);
        ...
        public function setRawError($message, $type)
        {
            ...
            $this->internalSpan->meta[Tag::ERROR_KIND] = $type;
        }
