...
final class Bootstrap
{
    ...
    public static function tracerOnce()
    {
        ...
        if (\dd_trace_env_config('DD_TRACE_GENERATE_ROOT_SPAN') || PHP_VERSION_ID < /*80000*/ PHP_INT_MAX) {
            ...
            register_shutdown_function(function () {
                ...
                */
                register_shutdown_function(function () {
                    ...
                    if (PHP_VERSION_ID < /*80000*/ PHP_INT_MAX) { // internal handling
    ...
    {
        $tracer = new Tracer(new HttpSignalFx(new JsonZipkinV2()));
