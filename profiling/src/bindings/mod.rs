...
pub type VmMmCustomAllocFn = unsafe extern "C" fn(size_t) -> *mut libc::c_void;
pub type VmMmCustomReallocFn = unsafe extern "C" fn(*mut libc::c_void, size_t) -> *mut libc::c_void;
