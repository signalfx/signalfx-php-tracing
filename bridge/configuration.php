...
/**
 * SIGNALFX: whether the autogenerated web.request root span name should be set to Drupal route path
 */
function sfx_trace_config_drupal_rename_span()
{
    return \_ddtrace_config_bool(\ddtrace_config_read_env_or_ini('SIGNALFX_DRUPAL_RENAME_ROOT_SPAN'), true);
}
