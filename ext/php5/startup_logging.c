...
void ddtrace_startup_diagnostics(HashTable *ht, bool quick) {
    ...
    _dd_check_for_deprecated_env(ht, ZEND_STRL("SIGNALFX_SERVICE_NAME"), ZEND_STRL("SIGNALFX_SERVICE") TSRMLS_CC);
    _dd_check_for_deprecated_env(ht, ZEND_STRL("SIGNALFX_TRACE_APP_NAME"), ZEND_STRL("SIGNALFX_SERVICE") TSRMLS_CC);
    _dd_check_for_deprecated_env(ht, ZEND_STRL("ddtrace_app_name"), ZEND_STRL("SIGNALFX_SERVICE") TSRMLS_CC);
